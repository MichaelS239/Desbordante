...
int main(int argc, char** argv) {
    ...
    */
    ...
    std::cout << "Pair inference found not minimal: "
              << algos::hymd::lattice::pair_inference_not_minimal << std::endl;
    std::cout << "Pair inference found trivial: " << algos::hymd::lattice::pair_inference_trivial
              << std::endl;
    std::cout << "Pair inference lowered to 0: "
              << algos::hymd::lattice::pair_inference_lowered_to_zero << std::endl;
    std::cout << "Pair inference lowered to not 0: "
              << algos::hymd::lattice::pair_inference_lowered_non_zero << std::endl;
    std::cout << "Pair inference no violation discovered: "
              << algos::hymd::lattice::pair_inference_accepted << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Lowered to not 0 during lattice traversal: "
              << algos::hymd::lattice::traversal_lowered << std::endl;
    std::cout << "Lowered to 0 (deleted) during lattice traversal: "
              << algos::hymd::lattice::traversal_deleted << std::endl;
    std::cout << "Unsupported: " << algos::hymd::unsupported << std::endl;
    std::cout << std::endl;
    std::cout << "Total interestingness CCV ID searches: "
              << algos::hymd::lattice::get_interestingness_ccv_ids_called << std::endl;
    std::cout << "Max CCV IDs detected for all column matches during raising: "
              << algos::hymd::lattice::raising_stopped << std::endl;
    std::cout << "Started interestingness bound search with max bounds for all column matches: "
              << algos::hymd::lattice::interestingness_stopped_immediately << std::endl;
    std::cout << "Interestingness CCV ID requested for every column match: "
              << MaxHitToString(algos::hymd::lattice::interestingness_indices_requested,
                                algos::hymd::lattice::column_matches_size)
              << std::endl;
    std::cout << "Max CCV ID hit for every column match: "
              << MaxHitToString(algos::hymd::lattice::interestingness_indices_hit,
                                algos::hymd::lattice::column_matches_size)
              << std::endl;
    std::cout << "Started with max CCV ID for every column match: "
