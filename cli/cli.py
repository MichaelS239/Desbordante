...
Assotiation Rules Mining" paper by S.Kwashie et al.
...
For more information, refer to "Differential Dependencies: Reasoning
...
These distance constraints construct the search space. For example,
